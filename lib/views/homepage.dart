                ...
                InkWell(
                  onTap: () {
                    Navigator.push(
                        ...
                        MaterialPageRoute(
                            builder: (context) =>
                                ProfilePage(myName.toString(), myUsername.toString(), myProfilePic.toString(), myEmail.toString(), true)));
                  },
                  child: Container(
                    padding: EdgeInsets.symmetric(
                      horizontal: 16,
                    ...
                    Expanded(
                      child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(color: Colors.blue.shade800, width: 2.0, style: BorderStyle.solid),
                          ),
                          child: Row(
                            children: [
                              Expanded(
